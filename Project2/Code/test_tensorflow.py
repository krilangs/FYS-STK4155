...
training_set = np.load("Data/Credit_train.npz")
...
model.fit(X_train, y_train, epochs=1000, batch_size=200, workers=2,
          shuffle=True, use_multiprocessing=True, validation_data=(X_test, y_test))
